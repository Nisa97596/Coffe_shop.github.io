                ...
                <div class="Tabel_menu">
                    ...
                    <div class="main_tabel">
                        ...
                        <div class="card-header">
                            ...
                            Data Transaksi
                            <a href="input-transaksi.php"><button class="btn_tambah">Tambah Data Baru</button></a>
                        </div>
                        <table border="1">
                            <thead>
                                <tr>
                    ...
                    while ($tampil = mysqli_fetch_array($data)) {
                        ...
                        <tr class="head">
                            <td>
                                <?php echo $tampil['id_transaksi'] ?>
                            </td>
                            <td>
                                <?php echo $tampil['id_karyawan'] ?>
                            </td>
                            <td>
                                <?php echo $tampil['id_menu'] ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="hapus-transaksi.php?id=<?php echo $tampil['id_transaksi']; ?>"><button
                                        class="hapus">Hapus</button></a>
                                <a href="edit-transaksi.php?id=<?php echo $tampil['id_transaksi']; ?>"><button
