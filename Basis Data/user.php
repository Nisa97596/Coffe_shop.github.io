                ...
                <div class="Tabel_menu">
                    ...
                    <div class="main_tabel">
                        ...
                        <div class="card-header">
                            ...
                            Data User
                            <a href="input-user.php"><button class="btn_tambah">Tambah Data Baru</button></a>
                        </div>
                        <table border="1">
                            <thead>
                                <tr>
                    ...
                    while ($tampil = mysqli_fetch_array($data)) {
                        ...
                        <tr class="head">
                            ...
                            <td>
                                <a href="hapus-user.php?id=<?php echo $tampil['id_user']; ?>"><button
                                        class="hapus">Hapus</button></a>
                                <a href="edit-user.php?id=<?php echo $tampil['id_user']; ?>"><button
