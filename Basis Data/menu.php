                ...
                <div class="Tabel_menu">
                    ...
                    <div class="main_tabel">
                        ...
                        <div class="card-header">
                            ...
                            Data Menu
                            <a href="input-menu.php"><button class="btn_tambah">Tambah Data Baru</button></a>
                        </div>
                        <table border="1">
                            <thead>
                                <tr>
                    ...
                    while ($tampil = mysqli_fetch_array($data)) {
                        ...
                        <tr class="head">
                            ...
                            <td>
                                <a href="hapus-menu.php?id=<?php echo $tampil['id_menu']; ?>"><button
                                        class="hapus">Hapus</button></a>
                                <a href="edit-menu.php?id=<?php echo $tampil['id_menu']; ?>"><button
